...
> = {
  ...
  DUPLICATE_WITH_CLIENT: {
    icon: <Copy />,
    color: '#6d28d9',
    description: 'Already exists on the client side',
  },
  DUPLICATE_WITH_LAW_FIRM: {
    icon: <Copy />,
    color: '#5b21b6',
    description: 'Already exists with the law firm',
  },
  RETURNED: {
    icon: <TimerOff />,
    color: '#475569',
  ...
  READY_TO_TRANSFER: {
    icon: <FastForward />,
    color: '#0284c7',
    description: 'Queued and ready for transfer',
  },
...
export const STATUS_SEQUENCE = [
  ...
  "WORKING", "QC", "CALL_BACK", "WAITING_ID", "PENDING", "REFRESH", "READY_TO_TRANSFER", "TRANSFERRED", "VM", "SEND_TO_ANOTHER_BUYER",
  "ATTEMPT_1", "ATTEMPT_2", "ATTEMPT_3", "ATTEMPT_4",
  "CAMPAIGN_PAUSED", "NOT_RESPONDING", "REJECTED", "REJECTED_BY_CLIENT", "DUPLICATE", "DUPLICATE_WITH_CLIENT", "DUPLICATE_WITH_LAW_FIRM", "RETURNED", "FELONY", "CHARGEBACK", "DEAD_LEAD"
];

export const BUCKETS = {
  PIPELINE: ["WORKING", "QC", "ATTEMPT_1", "ATTEMPT_2", "ATTEMPT_3", "ATTEMPT_4", "CALL_BACK", "PENDING", "WAITING_ID", "REFRESH", "READY_TO_TRANSFER", "VM", "TRANSFERRED"],
  CONVERSION: ["VERIFIED", "ID_VERIFIED", "SIGNED", "SENT_CLIENT", "SENT_TO_CLIENT", "PAID", "BILLABLE", "SENT_TO_LAW_FIRM", "POSTED"],
  RISK: ["REJECTED", "REJECTED_BY_CLIENT", "DUPLICATE", "DUPLICATE_WITH_CLIENT", "DUPLICATE_WITH_LAW_FIRM", "RETURNED", "NOT_RESPONDING", "FELONY", "DEAD_LEAD", "CHARGEBACK", "SEND_TO_ANOTHER_BUYER"]
};
