...
const LEAD_STATUSES = [
  "PENDING", "REJECTED", "VERIFIED", "REJECTED_BY_CLIENT","POSTED", "PAID", "SIGNED","VM","TRANSFERRED","READY_TO_TRANSFER","SEND_TO_ANOTHER_BUYER",
  "DUPLICATE", "DUPLICATE_WITH_CLIENT", "DUPLICATE_WITH_LAW_FIRM", "NOT_RESPONDING", "FELONY", "DEAD_LEAD", "WORKING", 
  "CALL_BACK", "ATTEMPT_1", "ATTEMPT_2", "ATTEMPT_3", "ATTEMPT_4", 
  "CHARGEBACK", "WAITING_ID", "SENT_TO_CLIENT", "QC", "ID_VERIFIED", 
  "BILLABLE", "CAMPAIGN_PAUSED", "SENT_TO_LAW_FIRM", "RETURNED", "REFRESH"
];
